...
- `state.md` — yêu cầu pháp lý an ninh mạng, bảo vệ dữ liệu cá nhân áp dụng cho ngành
- `products.md` — kiến trúc hệ thống, loại dữ liệu xử lý để đánh giá risk surface
