...
- `state.md` — danh sách giấy phép, hạn nộp báo cáo, nghĩa vụ ngành cụ thể
- `budget.md` — số liệu thuế, doanh thu để xác định ngưỡng kê khai
...
**Tham chiếu Brain:** laws.md (mục X), budget.md (mục Y)
