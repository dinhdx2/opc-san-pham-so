...
- `strategy.md` — North Star Metric, business objectives để frame analysis đúng câu hỏi; behavioral data, segmentation để phân tích cohort/retention
- `budget.md` — doanh thu, chi phí để quantify impact của findings bằng tiền
