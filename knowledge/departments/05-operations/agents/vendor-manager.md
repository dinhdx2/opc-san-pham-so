...
- `state.md` — danh sách NCC hiện tại, lịch sử đơn hàng, vấn đề tồn đọng; quy định hợp đồng thương mại, điều khoản bảo hành theo Luật TM 2005
- `budget.md` — ngân sách mua hàng, điều khoản thanh toán hiện tại
