...
## moat (cỗ-máy lợi-thế — chọn 1–2, bồi theo thời-gian)
- **CHỌN: (1) audience sở-hữu (email list + kênh content-led) + thương-hiệu cá-nhân creator; (2) cộng-đồng người dùng + thư-viện SP + tốc-độ ra SP mới** `[quyết-định CEO 2026-07-07]`.
- Lưu-ý CỨNG: với SP số (nhất là prompt/AI-content) moat KHÔNG phải file (dễ copy, và **asset AI-sinh có thể KHÔNG được bảo-hộ bản-quyền** — Governance) → phải dựa curation + brand + EULA + cộng-đồng.

> Định-vị này neo tầng `dinh-vi`. Đổi định-vị vì 1 chiến-dịch lỗi = sai tầng (xem lib/loop.js — leo tầng ưu-tiên thấp nhất trước).
