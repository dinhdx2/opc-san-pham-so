...
- Kênh phân-phối phổ-biến VN: sàn nội-dung (Unica, Kyna, Gitiho…), tự-host (web + cổng thanh-toán), mạng-xã-hội, Gumroad/Payhip cho global `[benchmark ngành — cần CEO xác minh]`
- Đối thủ trực-tiếp: `[cần CEO xác minh]`

## KPI mục tiêu
- Doanh thu/tháng: `[cần CEO xác minh]`
- Email list / followers: `[cần CEO xác minh]`
- Tỷ-lệ chuyển-đổi landing: `[benchmark ngành — cần CEO xác minh]` (tham khảo 1–3%)
- AOV: `[cần CEO xác minh]`
- CAC: `[cần CEO xác minh]`
- Tỷ-lệ hoàn/refund: mục tiêu < 5% `[benchmark ngành — cần CEO xác minh]`
- (Membership) MRR & churn: churn mục tiêu < 5%/tháng `[benchmark ngành — cần CEO xác minh]`
