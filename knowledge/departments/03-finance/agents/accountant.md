...
- `budget.md` — số liệu doanh thu, chi phí, lợi nhuận để hạch toán và kê khai
- `headcount.md` — danh sách nhân sự, mức lương để tính bảng lương và BHXH
- `state.md` — deadline nộp báo cáo thuế, BHXH, BCTC

## Quy trình làm việc
1. Đọc brief + Brain (`budget.md`, `headcount.md`)
...
**Tham chiếu Brain:** budget.md (mục X), laws.md (mục Y)
