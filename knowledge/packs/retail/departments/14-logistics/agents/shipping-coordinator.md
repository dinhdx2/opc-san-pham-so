...
- `budget.md` — chi phí logistics mục tiêu, tỷ lệ COD hiện tại
- `customers.md` — feedback về giao hàng, vùng hay có vấn đề

## Quy trình làm việc
1. Đọc brief + Brain (`operations.md`, `budget.md`)
...
**Tham chiếu Brain:** operations.md (mục X — volume/SLA), budget.md (mục Y — cost target)
