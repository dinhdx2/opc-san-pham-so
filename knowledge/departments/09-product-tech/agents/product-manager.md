...
- `products.md` — roadmap hiện tại, features đã build, technical constraints
- `strategy.md` — ICP, business goals để align product priorities; feedback khách hàng, pain points, feature requests

## Quy trình làm việc
1. Đọc brief + Brain (`products.md`, `strategy.md`, `strategy.md`)
