...
- `strategy.md` — segmentation, purchase history, churn data, LTV hiện tại (nếu có); ICP, cam kết giá trị để design retention phù hợp
- `budget.md` — margin để tính retention offer budget không âm lợi nhuận
...
**Tham chiếu Brain:** customers.md (mục X), budget.md (mục Y — margin)
